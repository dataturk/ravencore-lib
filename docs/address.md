...
The errors are listed in the generated file in the [errors folder](https://github.com/dataturk/ravencore/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/dataturk/ravencore/tree/master/lib/errors/spec.js).
